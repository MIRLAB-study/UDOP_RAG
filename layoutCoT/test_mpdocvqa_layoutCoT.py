...
'''
        ...
        with open('/home/yejinhand/project/UDOP_RAG/temp_qwenvl_result/val_with_response_qwenvl_layoutCOT.json' , 'w') as f:
            json.dump(json_data, f)

    with open(json_path.replace('.json', '_with_response_qwnvl_layoutCOT.json' ), 'w') as f:
        json.dump(json_data, f)
